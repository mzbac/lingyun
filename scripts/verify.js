...
async function checkToolDefinitions() {
  ...
  const toolFiles = [
    { path: 'dist/tools/builtin/file.js', exports: ['registerFileTools'] },
    { path: 'dist/tools/builtin/shell.js', exports: ['registerShellTools'] },
  ];
...
async function checkPackaging() {
  ...
  if (!fileExists('CHANGELOG.md') && !fileExists('CLAUDE.md')) {
