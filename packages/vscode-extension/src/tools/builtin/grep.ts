...
export const grepTool: ToolDefinition = {
  ...
  description:
    'Search for a regex pattern in files. Supports optional path (file or directory, workspace-scoped) and include glob. Returns up to 100 matches grouped by file, including line+column (1-based) for follow-up lsp/read.',
  parameters: {
    type: 'object',
    properties: {
