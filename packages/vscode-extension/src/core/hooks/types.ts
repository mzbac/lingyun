...
export type LingyunPluginInput = {
  ...
  storagePath?: string;
  /**
   * Log to the "LingYun" output channel.
   * Prefer this over `console.log`, which may not be visible depending on how the extension is run.
   */
...
export type LingyunHooks = {
  /**
   * Optional tool map. Tools are registered at extension activation time.
   * Keys are tool IDs (function names exposed to the model).
   */
