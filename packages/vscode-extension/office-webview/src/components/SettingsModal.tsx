  ...
  return (
    <>
      ...
      >
        ...
        <button
          onClick={() => {
            const message: WebviewToExtensionMessage = { type: 'openSessionsFolder' }
        ...
        <button
          onClick={() => {
            const message: WebviewToExtensionMessage = { type: 'exportLayout' }
            vscode.postMessage(message)
            onClose()
          }}
        ...
        <button
          onClick={() => {
            const message: WebviewToExtensionMessage = { type: 'importLayout' }
            vscode.postMessage(message)
            onClose()
          }}
        ...
        <button
          onClick={() => {
            ...
            const message: WebviewToExtensionMessage = { type: 'setSoundEnabled', enabled: newVal }
            vscode.postMessage(message)
          }}
