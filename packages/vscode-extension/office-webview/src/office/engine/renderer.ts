...
export function renderScene(
  ...
  for (const ch of characters) {
    ...
    const sittingOffset = seats && isCharacterSeated(ch, seats) ? CHARACTER_SITTING_OFFSET_PX : 0
...
export function renderBubbles(
  ...
  for (const ch of characters) {
    ...
    const sittingOff = seats && isCharacterSeated(ch, seats) ? BUBBLE_SITTING_OFFSET_PX : 0
