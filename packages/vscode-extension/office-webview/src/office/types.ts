...
export interface Character {
  ...
  /** Current high-level work type (e.g. read/search/write/execute), or null */
  currentWorkType: string | null
  /** Optional target tile to "work at" while active (tool station). Null = default seat behavior. */
  workTarget: { col: number; row: number; dir: Direction } | null
  /** Palette index (0-5) */
  palette: number
